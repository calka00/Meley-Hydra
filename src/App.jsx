...
const load = () => { try { const saved = JSON.parse(localStorage.getItem(STORAGE_KEY)); return saved ? { ...initial, ...saved, meley: { ...initial.meley, ...saved.meley } } : initial } catch { return initial } }
