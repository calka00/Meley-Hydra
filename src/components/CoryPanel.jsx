...
export default function CoryPanel({ cory, now, onChange }) {
  ...
  const addCharacter = () => { if (account.characters.length < 9) updateAccount({ characters: [...account.characters, { id: crypto.randomUUID(), name: `Postać ${account.characters.length + 1}` }] }) }
