...
export default function MeleyCard({ meley, now, onRegister, onEnter, onReset }) {
  ...
  return <DungeonCard className="meley" title="Meley" eyebrow="Dungeon · cykl 4 godziny" status={labels[meley.phase]}>
    ...
    {meley.phase === 'readyToRegister' && <button className="button accent amber" onClick={onRegister}>Zarejestruj</button>}
